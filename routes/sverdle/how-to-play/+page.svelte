<svelte:head>
	<title>How to play Wurdle</title>
	<meta name="description" content="How to play Sverdle" />
</svelte:head>

<div class="text-column">
	<h1>How to play Wurdle</h1>

	<p>
		A clone of <a href="https://www.nytimes.com/games/wordle/index.html">Wordle</a>, the
